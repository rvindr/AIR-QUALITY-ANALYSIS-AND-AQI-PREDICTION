...
Before committing to R&D and production, AirPure needs answers to:

| # | Critical Question |
|---|-------------------|
| 1 | What pollutants should the air purifier target? |
| 2 | What features are most essential for the product? |
| 3 | Which cities have the highest demand, and what is the market size? |
| 4 | How can R&D be aligned with localized pollution patterns? |

The analysis is structured around **three analytical dimensions**:

```
📍 Severity Mapping      →  Identify cities with persistent/worsening AQI
🏥 Health Impact         →  Quantify health burden due to pollution  
📣 Demand Triggers       →  Pollution spikes ↔ consumer behaviour shifts
```
...
```python
OBJECTIVES = [
    "01. Import libraries and set up environment",
    "02. Load and understand four real-world datasets",
    "03. Data cleaning and preprocessing",
    "04. Exploratory Data Analysis (EDA) with visualizations",
    "05. Vehicle registration and EV adoption analysis",
    "06. Disease and health impact analysis",
    "07. Statistical and correlation analysis",
    "08. Machine Learning – Regression models",
    "09. Machine Learning – Classification models",
